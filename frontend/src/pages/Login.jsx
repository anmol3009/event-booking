    ...
    <div className="min-h-[80vh] flex items-center justify-center px-6 py-12">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        ...
        <div className="rounded-lg border p-8" style={{ borderColor: isDark ? '#1a1a1a' : '#eee', background: isDark ? '#0a0a0a' : '#fafafa' }}>
          ...
          <div className="mb-6">
            <label className="block text-xs uppercase tracking-wider mb-2 font-semibold" style={{ color: isDark ? '#555' : '#aaa' }}>
              Referral Code (Optional)
            </label>
            <input
              type="text"
              ...
              className="w-full rounded border px-4 py-3 text-sm focus:outline-none transition-all font-mono"
              style={{
          ...
          <button
            ...
            style={{
              background: loading ? (isDark ? '#111' : '#f5f5f5') : '#7DA8CF',
          ...
          >
            {loading ? (
              ...
              <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24">
                <path fill="#000" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92a5.06 5.06 0 01-2.2 3.32v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.1z"/>
